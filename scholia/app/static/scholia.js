...
function sparqlToDataTable(sparql, element, options={}) {
    sparqlToDataTableOnEndPoint("https://query.wikidata.org/bigdata/namespace/wdq/sparql", sparql, element, options);
}

function sparqlToDataTableOnEndPoint(endpoint, sparql, element, options={}) {
